...
public class StorageUtils {
    ...
    public static void setTextInStorage(File rootDestination, Context context, String fileName,
                                        String folderName, String text) {

        File file = createOrGetFile(rootDestination, fileName, folderName);
        wrtieOnFile(context, text, file);
    ...
    private static void wrtieOnFile(Context context, String text, File file) {
        ...
        try {
            ...
            Toast.makeText(context, context.getString(R.string.error_happened), Toast.LENGTH_SHORT)
                    .show();
        }
