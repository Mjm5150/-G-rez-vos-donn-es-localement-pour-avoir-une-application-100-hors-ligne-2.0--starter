...
public class ItemDaoTest {
    ...
    private static User USER_DEMO = new User(USER_ID, "Philippe",
            "https://www.google.fr, ");

    private static Item NEW_ITEM_PLACE_TO_VISIT = new Item("Visite cet endroit de rêve !",
            0, USER_ID);
    private static Item NEW_ITEM_IDEA = new Item("On pourrait faire du chien de traîneau ?",
            1, USER_ID);
    private static Item NEW_ITEM_RESTAURANTS = new Item("Ce restaurant à l'air sympa",
            2, USER_ID);
    ...
    public void insertAndGetItems() throws InterruptedException {
        // BEFORE : Adding demo user and demo items
    ...
    public void insertAndUpdateItem() throws InterruptedException {
        // BEFORE : Adding demo user and demo items. Next, update item added & re-save it
        this.database.userDao().createUser(USER_DEMO);
        this.database.itemDao().insertItem(NEW_ITEM_PLACE_TO_VISIT);
    ...
    public void insertAndDeleteItem() throws InterruptedException {
        // BEFORE : Adding demo user and demo item. Next, get the item added and delete it.
        this.database.userDao().createUser(USER_DEMO);
        this.database.itemDao().insertItem(NEW_ITEM_PLACE_TO_VISIT);
        Item itemAdded = LiveDataTestUtil.getValue(this.database.itemDao().getItems(USER_ID)).get(0);
    ...
    public void insertAndGetUser() throws InterruptedException {
        ...
        assertTrue(user.getUsername().equals(USER_DEMO.getUsername())
                && user.getId() == USER_ID);
